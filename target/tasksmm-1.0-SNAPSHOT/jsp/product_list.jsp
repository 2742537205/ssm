...
<html>
	...
	<%@include file="/jsp/header.jsp"%>
		...
		<div class="row" style="width:1210px;margin:0 auto;" id="di">
			<div class="col-md-12">
				<ol class="breadcrumb">
					<li><a href="#">首页</a></li>
				</ol>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;" id="ul">
	...
	<script src="${pageContext.request.contextPath}/js/pageData.js" type="text/javascript"></script>
	</body>
