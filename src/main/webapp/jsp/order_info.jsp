...
<html>
			...
			<div class="row">
				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								<th colspan="5" id="id">订单编号:${list.orderId}</th>
							</tr>
							<tr class="warning">
								<th>图片</th>
								<th>商品</th>
				...
				<div style="text-align:right;margin-right:120px;">
					商品金额: <strong style="color:#ff6600;">￥${list.sumPrice}元</strong>
				</div>
			</div>
	...
	<script src="${pageContext.request.contextPath}/js/addOrder.js" type="text/javascript"></script>
	</body>
